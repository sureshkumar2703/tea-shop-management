...
-- Helper function to fetch the current user's role from public.users
...
-- Helper function to fetch the current user's shop_id from public.users
...
CREATE POLICY "Super admin full access to categories" ON public.categories FOR ALL TO authenticated USING (public.get_auth_user_role() = 'ADMIN');
...
CREATE POLICY "Super admin full access to products" ON public.products FOR ALL TO authenticated USING (public.get_auth_user_role() = 'ADMIN');
...
CREATE POLICY "Super admin full access to variants" ON public.product_variants FOR ALL TO authenticated USING (public.get_auth_user_role() = 'ADMIN');
...
CREATE POLICY "Super admin full access to addons" ON public.addons FOR ALL TO authenticated USING (public.get_auth_user_role() = 'ADMIN');
...
CREATE POLICY "Shop admin manage inventory" ON public.inventory_items FOR ALL TO authenticated USING (shop_id = public.get_auth_user_shop_id() AND public.get_auth_user_role() IN ('OWNER', 'ADMIN'));
...
CREATE POLICY "Shop admin manage purchases" ON public.purchases FOR ALL TO authenticated USING (shop_id = public.get_auth_user_shop_id() AND public.get_auth_user_role() IN ('OWNER', 'ADMIN'));
CREATE POLICY "Shop admin manage purchase items" ON public.purchase_items FOR ALL TO authenticated 
USING (EXISTS (SELECT 1 FROM public.purchases p WHERE p.id = purchase_id AND p.shop_id = public.get_auth_user_shop_id() AND public.get_auth_user_role() IN ('OWNER', 'ADMIN')));
...
-- 7. EXPENSES & SALARIES
CREATE POLICY "Shop admin manage expenses" ON public.expenses FOR ALL TO authenticated USING (shop_id = public.get_auth_user_shop_id() AND public.get_auth_user_role() IN ('OWNER', 'ADMIN'));
CREATE POLICY "Shop admin manage salaries" ON public.salaries FOR ALL TO authenticated USING (shop_id = public.get_auth_user_shop_id() AND public.get_auth_user_role() IN ('OWNER', 'ADMIN'));
...
CREATE POLICY "Shop admin read audit logs" ON public.audit_logs FOR SELECT TO authenticated USING (shop_id = public.get_auth_user_shop_id() AND public.get_auth_user_role() IN ('OWNER', 'ADMIN'));
